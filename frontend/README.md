# EdCast Frontend Product Exercise
...
### You can also take a look at 2 new exercises added. See [React Assignments](https://github.com/edcast/hiring-exercises/blob/master/frontend/assignments.md)
